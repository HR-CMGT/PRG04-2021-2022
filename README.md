...
| 4 | Encapsulation | App doorgeven. Score bijhouden. UI Class. [Keyboard controls](./snippets/keyboard.md). Collision detection.  | [Vector Math](./facultatief/vector.md) | Zelf evaluatie |
